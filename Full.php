...
<html lang="en">
  ...
  <tr>
	...
	<td class="tooltip" data-tooltip="Heure initialiement prévue dans la gare où vous avez subi le préjudice (ce champ sert à identifier le train)">
	    <label id="initialTimeLabel" style="visibility:hidden;">Heure prévue à l'arrêt </label>
  ...
  <tr>
    <td>Gare du préjudice</td>
  	<td class="tooltip" data-tooltip="Gare où vous avez subi le problème"><input type="text" name="trainStop" list="station-list" required></td>
  </tr>
